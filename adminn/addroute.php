...
<body class="dark-edition">
  <div class="wrapper ">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Add Route</a>
          </div>
   ...
   -->        </div>
              <div class="card-body">
                  <form action="../faddroute.php" method="post">  
                     <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            <label class="bmd-label-floating">Destination 1</label>
                            <input type="text" class="form-control" name="d1">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label class="bmd-label-floating">Destination 2</label>
                    ...
                    <button type="submit" class="btn btn-primary pull-right" name="add">Add Route</button>
