      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Edit Route</a>
          </div>
   ...
   -->        </div>
              <div class="card-body">
                <?php
                  ...
                  $sql = $con->query("SELECT * FROM routes WHERE route_id = '$rid' ");
                  $row = $sql->fetch_array();
                ...
                ?>
                  <form action="../faddroute.php?rid=<?php echo $rid?>" method="post">  
                     <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="rrate" value="<?php echo $rrate ?>">
                          </div>
                        </div>
                      </div>
                    <button type="submit" class="btn btn-primary pull-right" name="update">Update Route</button>
